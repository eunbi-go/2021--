...
class MainGUI:
    ...
    def SetButton(self):
        ...
        self.boxOffice = Button(mainWnd, text='배우 검색', font=tmpFont,
                                command=SearchActor, width=15, height=5)
        self.boxOffice.place(x=0, y=360)
